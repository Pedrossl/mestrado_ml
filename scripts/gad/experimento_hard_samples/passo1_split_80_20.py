...
import os
os.makedirs('output/gad/experimento_hard_samples', exist_ok=True)
np.save('output/gad/experimento_hard_samples/X_treino.npy', X_treino)
np.save('output/gad/experimento_hard_samples/X_teste.npy',  X_teste)
np.save('output/gad/experimento_hard_samples/y_treino.npy', y_treino)
np.save('output/gad/experimento_hard_samples/y_teste.npy',  y_teste)
print("Arquivos salvos em output/gad/experimento_hard_samples/")
